...
public class JSHintPreferences {
	...
	public void setCustomLibPath(final String customLibPath) {
		try {
			writeLock.lock();
	...
	public void setEnableErrorMarkers(final boolean enableErrorMarkers) {
		try {
			writeLock.lock();
	...
	public void setUseCustomLib(final boolean useCustomLib) {
		try {
			writeLock.lock();
